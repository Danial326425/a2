  ...
  return (
    <div className="mx-4 mt-4 space-y-3">
      <button
        onClick={onAccept}
        disabled={loading}
        className="w-full py-4 px-6 rounded-2xl text-base font-extrabold shadow-lg transition-all active:scale-95 disabled:opacity-70 cursor-pointer disabled:cursor-not-allowed"
        style={{
      ...
      <button
        onClick={onDecline}
        disabled={loading}
        className="w-full py-2 text-xs transition-all disabled:opacity-50 cursor-pointer disabled:cursor-not-allowed"
